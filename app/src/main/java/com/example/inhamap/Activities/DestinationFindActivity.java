...
public class DestinationFindActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("목적지 검색");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_search:
                ...
                Intent intent = new Intent(this, DestinationDoorActivity.class);
                startActivity(intent);
                return true;
            case R.id.action_settings2:
                Toast.makeText(getApplicationContext(), "항목 1 버튼 클릭됨", Toast.LENGTH_LONG).show();
                Intent intent2 = new Intent(this, DestinationDoorActivity.class);
